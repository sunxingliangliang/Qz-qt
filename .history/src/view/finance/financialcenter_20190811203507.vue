...
export default {
  ...
  methods: {
    ...
    selectionperiod () {
      if (this.value1 === null) {
        console.log(1)
        this.$http.get('pc/account/list?size=10').then(res => {
          var { code, data } = res.data
          if (code === 1000) {
        ...
        console.log(2)
        this.$http.get(`pc/account/list?values=${str}`).then(res => {
          var { code, data } = res.data
          if (code === 1000) {
            this.recharge = data.content
            this.total = data.total
    ...
    Numberofrecharges (val) {
      this.sizes = val;
      this.$http.get(`pc/account/list?size=${val}`).then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.recharge = data.content
          this.total = data.total
    ...
    Topuppaging (val) {
      this.$http.get(`pc/account/list?page=${val - 1}&size=${this.sizes}`).then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.recharge = data.content
          this.total = data.total
    ...
    handleCurrentChange (val) {
      this.$http.get(`pc/account/list?page=${val - 1}&size=${this.sizes1}`).then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.TransactionRecord = data.content
          this.totaarticlel = data.total
    ...
    ywc () {
      ...
      this.xz8 = true
      this.xz9 = false
      this.$http.get('pc/account/list?size=10&type=0').then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.recharge = data.content
          this.total = data.total
    ...
    wwc () {
      ...
      this.xz8 = true
      this.xz9 = false
      this.$http.get('pc/account/list?size=10&type=5').then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.recharge = data.content
          this.total = data.total
    ...
    zzrw () {
      ...
      this.xz8 = true
      this.xz9 = false
      this.$http.get('pc/account/list?size=10&type=6').then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.recharge = data.content
          this.total = data.total
