  ...
  <div class="bj">
    ...
    <div :class="$style.f_cjdd">
      ...
      <el-row :class="$style.f_row">
        ...
        <el-input placeholder="请输入内容" v-model="taskname" :class="$style.f_inpt" clearable></el-input>
        <p :class="$style.f_rwmc">任务编号</p>
        <el-input placeholder="请输入内容" v-model="taskserial" :class="$style.f_inpt" clearable></el-input>
        <p :class="$style.f_rwmc">采集距离</p>
        <el-input placeholder="请输入内容" v-model="removing" :class="$style.f_inpt" clearable></el-input>
