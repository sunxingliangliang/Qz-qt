  ...
  <div class="bj">
    ...
    <div :class="$style.f_cjdd">
      ...
      <el-row :class="$style.f_row">
        ...
        <el-input placeholder="请输入内容" v-model="taskname" :disabled="true" :class="$style.f_inpt" clearable></el-input>
        <p :class="$style.f_rwmc">任务编号</p>
        <el-input placeholder="请输入内容" v-model="taskserial" :disabled="true" :class="$style.f_inpt" clearable></el-input>
        <p :class="$style.f_rwmc">采集距离</p>
        <el-input placeholder="请输入内容" v-model="removing" :disabled="true" :class="$style.f_inpt" clearable></el-input>
      ...
      <div :class="$style.f_bgnr">
        <el-table :data="tableData" border style="width: 100%;">
          <el-table-column prop="date" align="center" label="奖金池" width="180"></el-table-column>
          <el-table-column prop="name" align="center" label="任务量" width="180"></el-table-column>
          <el-table-column prop="address" align="center" label="单条奖励"></el-table-column>
          <el-table-column prop="address" align="center" label="已完成"></el-table-column>
          <el-table-column prop="address" align="center" label="已获奖励"></el-table-column>
        </el-table>
      </div>
      ...
      <div :class="$style.f_bgnr">
        <el-table :data="tableData" border style="width: 100%;">
          <el-table-column prop="date" align="center" label="采集地区" width="180"></el-table-column>
          <el-table-column prop="name" align="center" label="数据类型" width="180"></el-table-column>
