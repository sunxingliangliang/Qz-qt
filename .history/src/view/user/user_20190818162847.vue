        ...
        <el-tab-pane label="修改密码" name="second">
          <div :class="$style.f_userxx">
            ...
            <div :class="$style.f_userxinxi1">
              <span>原密码</span>
              <el-input placeholder="请输入内容" :class="$style.f_inpt3" v-model="password" clearable></el-input>
            </div>
            <div :class="$style.f_userxinxi1">
              <span>新密码</span>
              <el-input placeholder="请输入内容" :class="$style.f_inpt3" v-model="newpassword" clearable></el-input>
            </div>
            <div :class="$style.f_userxinxi1">
              <span>确认密码</span>
              <el-input
