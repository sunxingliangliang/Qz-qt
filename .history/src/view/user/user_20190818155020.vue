...
export default {
  ...
  methods: {
    ...
    user () {
      ...
      console.log(userinfo.merchantInfo.proxyType)
      this.input1 = userinfo.user.username
      this.input = userinfo.user.name
      // this.input2 = userinfo.merchantInfo.account.name
      // this.input3 = userinfo.merchantInfo.account.name
      // if (userinfo.merchantInfo.proxyType === 1) {
      //   this.input4 = '省级运营中心'
      // } else if (userinfo.merchantInfo.proxyType === 2) {
      //   this.input4 = '市级运营中心'
      // } else if (userinfo.merchantInfo.proxyType === 3) {
      //   this.input4 = '市级一般代理商'
      // } else if (userinfo.merchantInfo.proxyType === 4) {
      //   this.input4 = '大客户'
      // } else if (userinfo.merchantInfo.proxyType === 5) {
      //   this.input4 = '青竹数据'
      // }
      this.getProvince()
    },
