  ...
  methods: {
    ...
    sceneheading () {
      ...
      if(this.datastamp===1){
        ...
        this.$http.get(`pc/collect/getScencesName?`,{params:{
          province:this.adress[0],
          city:${this.adress[1]},area:this.adress[2],type:1,industryParent=${this.onedistrict[0]}&industry=${this.onedistrict[1]}&industrytypeParent=${this.twodistrict[0]}&industrytype=${this.twodistrict[1]}
        }}).then(res=>{
          var {code,data}=res.data
          console.log(data)
          if(code===1000){
