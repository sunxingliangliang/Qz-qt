  ...
  methods: {
    ...
    increase () {
      ...
      if (this.datastamp === 1) {
        ...
        arr.push(this.provincialcollection.pop(), this.citycollection.pop(), this.regionalcollection.pop())
        regionalcategory.push(this.industrycollection.pop(), this.industrysubdivisioncollection, )
        regionalsubcategory.push(this.propertycollection.pop(), this.propertysubdivisioncollection)
        let obj = {}
        var arr2 = arr.join("\\");
        var arr3 = regionalcategory.join("\\");
        var arr4 = this.sceneappellation.join("\\");
