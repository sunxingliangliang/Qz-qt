...
export default {
  ...
  methods: {
    ...
    scenename () {
      ...
      if (this.datastamp === 1) {
        // 区域
        this.$http.get(`pc/collect/getScencesName?area=${this.adress[2]}&type=1&industryParent=${this.onedistrict[0]}&industry=${this.onedistrict[1]}&industrytypeParent=${this.twodistrict[0]}&industrytype=${this.twodistrict[1]}`, {          params: {
