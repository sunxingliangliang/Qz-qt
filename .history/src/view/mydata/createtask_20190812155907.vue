  ...
  methods: {
    ...
    sceneheading () {
      ...
      if (this.datastamp === 1) {
        ...
        // 行业
        this.$http.get(`pc/collect/getScencesName?&area=${this.adress[2]}&type=2&industryParent=${this.trade[0]}&industry=${this.trade[1]}&industrytypeParent=${this.twotrade[0]}&industrytype=${this.twotrade[1]}`,{params:{
          province:this.adress[0],
          city:this.adress[1],
          area:this.adress[2],
          type:1,
