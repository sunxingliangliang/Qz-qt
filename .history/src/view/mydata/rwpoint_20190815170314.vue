      ...
      this.$http.get(`pc/task/detail/${this.id}`).then(res => {
        ...
        if (code === 1000) {
          ...
          let money={
            ...
            surplus:data.platformTask.bonusCount-(data.platformTask.price*dataNum),
            bonusCount:data.platformTask.bonusCount,
            surplusdata:data.platformTask.amountCount-dataNum,
            amountCount:data.platformTask.amountCount,
            dataNum:dataNum,
            rewardreward:data.platformTask.price*dataNum
          }
