    ...
    <div :class="$style.f_table">
      ...
      <div v-if="xz1===true">
        <div :class="$style.f_bgnr">
          <el-table :data="tableData" @select="handleSelectionChange" border style="width: 100%">
...
export default {
  ...
  methods: {
    ...
    ywc () {
      ...
      this.xz8 = true
      this.xz9 = false
      this.$http.get(`pc/platform/list?status=1&size=${10}`).then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.tableData = data.content
          this.tableData.forEach(item => {
    ...
    zzrw () {
      ...
      this.xz8 = true
      this.xz9 = false
      this.$http.get(`pc/platform/list?status=3&size=${10}`).then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.tableData = data.content
          this.tableData.forEach(item => {
    ...
    wwc () {
      ...
      this.xz8 = true
      this.xz9 = false
      this.$http.get(`pc/platform/list?status=2&size=${10}`).then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.tableData = data.content
          this.tableData.forEach(item => {
    ...
    inquire () {
      if (this.xz1 === true) {
        console.log('全部')
        this.$http.get(`pc/platform/list?search=${this.searchcontent}&size=10`).then(res => {
          var { code, data } = res.data
          if (code === 1000) {
            this.tableData = data.content
            this.tableData.forEach(item => {
        ...
        console.log('进行中')
        this.$http.get(`pc/platform/list?status=1&search=${this.searchcontent}&size=10`).then(res => {
          var { code, data } = res.data
          if (code === 1000) {
            this.tableData = data.content
            this.tableData.forEach(item => {
        ...
        console.log('已结束')
        this.$http.get(`pc/platform/list?status=2&search=${this.searchcontent}&size=10`).then(res => {
          var { code, data } = res.data
          if (code === 1000) {
            this.tableData = data.content
            this.tableData.forEach(item => {
        ...
        console.log('已取消')
        this.$http.get(`pc/platform/list?status=3&search=${this.searchcontent}&size=10`).then(res => {
          var { code, data } = res.data
          if (code === 1000) {
            this.tableData = data.content
            this.tableData.forEach(item => {
...
'price', 232
          ...
          this.$http.post(`pc/task/orderPersona`, digital).then(res => {
            var { code, data } = res.data
            if (code === 1000) {
              this.$message({
                type: 'success',
