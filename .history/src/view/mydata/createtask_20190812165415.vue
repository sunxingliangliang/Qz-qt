  ...
  methods: {
        ...
        this.$http.get(`modules/signRegion/listByParent`, {          params: {
          ...
          if (code === 1000) {
            ...
            this.secondaryarea.forEach(item => {
              ...
              if(this.onedistrict[1]===item.id){
                this.secondaryarealection.push(item.name)
              }
            })
          } else if (code == 2001) {
            this.$message.error(res.data.message);
    ...
    increase () {
      ...
      if (this.datastamp === 1) {
        ...
        regionalcategory.push(this.districtcollection.pop(), this.secondaryarea.pop(), )
