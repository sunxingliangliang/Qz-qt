  ...
  methods: {
    ...
    submit () {
      this.$confirm('是否确定发布任务, 是否继续?', '提示', {
        ...
        info.append('TaskCollectType', this.missionname)
        info.append('radius', this.missionname)
        info.append('fromDate', this.missionname)
        info.append('toDate', this.missionname)
        ...
        this.$http.post(`pc/platform/addPlatformTask`,{headers:{"Content-Type": "multipart/form-data"}}, info).then(res => {
