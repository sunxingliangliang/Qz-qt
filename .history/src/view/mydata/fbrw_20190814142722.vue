  ...
  <div :class="$style.f_bj">
    ...
    <div :class="$style.f_cjdd">
      ...
      <el-row :class="$style.f_row">
        ...
        <el-input clearable :class="$style.f_inpt" v-model="datanum" @focus="planning" placeholder="请选择"></el-input>
        <p :class="$style.f_rwmc">单条奖励</p>
        <el-input clearable :class="$style.f_inpt" v-model="single" @focus="planning" placeholder="请选择"></el-input>
