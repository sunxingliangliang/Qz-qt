              ...
              <div>
                <div :class="$style.f_cztable">
                  <el-table :data="recharge" style="width: 100%">
                    ...
                    <el-table-column prop="account" align="center" label="转出账户" width="180"></el-table-column>
          ...
          <div :class="$style.f_zttb" style="    padding-bottom: 20px;">
            <div :class="$style.f_sjfwcny" style="    margin-right: 30px;">
              ...
              <div :class="$style.f_shujufuw1">
                <p :class="$style.f_cny1">{{SERVICE}}</p>
...
export default {
  ...
  methods: {
    getCount () {
      this.$http.get(`pc/account/count`).then(res => {
    ...
    getZj () {
      ...
      this.id = this.$store.state.userinfo.merchant.proxyType
