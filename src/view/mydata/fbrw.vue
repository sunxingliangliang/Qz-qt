  ...
  <div :class="$style.f_bj">
    ...
    <div :class="$style.f_cjdd">
      ...
      <el-row :class="$style.f_row">
        ...
        <el-input v-model="input1" style="width:calc(100% - 80%)" :disabled="true"></el-input>
      </el-row>
      <!-- 任务备注 -->
    ...
    submit () {
      this.$confirm('是否确定发布任务, 是否继续?', '提示', {
        ...
        for (let i in this.beanse) {
          info.append(`beans[${i}].scencesBaseId`, this.beanse[i].scencesBaseId)
          info.append(`beans[${i}].crowdId`, this.beanse[i].crowdId)
        }
